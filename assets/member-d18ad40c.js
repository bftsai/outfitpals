import"./main-988f3ba4.js";const k="https://outfitpals-web-server.onrender.com/";function d(e){const t=document.cookie.split(";").find(i=>{if(i.split("=")[0].trim()===e)return i});return t===void 0?void 0:t.split("=")[1]}const E={data:[],async register(e){try{const t=await axios.post(`${k}register`,e);if(t.status==201){document.cookie=`outfitpalsToken=${t.data.accessToken}`,document.cookie=`outfitpalsId=${t.data.user.id}`,document.cookie=`outfitpalsThirdParty=${t.data.user["third party"]}`;const i=Number(d("outfitpalsId")),n=d("outfitpalsToken");await this.patchUsers(i,n,{"sign time":`${new Date}`}),signUpMail.value=account.value,signUpPwd.value=pwd.value,memberIndex.classList.add("opacity-0"),setTimeout(()=>{account.value="",pwd.value="",memberIndex.classList.add("d-none"),memberSignUpData.classList.remove("d-none"),setTimeout(()=>{memberSignUpData.classList.remove("opacity-0")},0)},400)}}catch(t){console.log(t.response),memberIndexForm.classList.add("was-validated"),account.classList.add("is-invalid"),account.nextElementSibling.textContent=t.response.data,account.setAttribute("style","border-color: var(--bs-form-invalid-border-color);background-image: url('../assets/images/member/invalid.png');background-repeat: no-repeat;background-position: right calc(0.375em + 0.1875rem) center;background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);")}},async patchUsers(e,t,i){console.log(e,t,i);try{const n=await axios.patch(`${k}600/users/${e}`,i,{headers:{authorization:`Bearer ${t}`}})}catch(n){console.log(n)}},async signIn(e){try{const t=await axios.post(`${k}signin`,e);console.log(t),t.status===200&&(document.cookie=`outfitpalsToken=${t.data.accessToken}`,document.cookie=`outfitpalsId=${t.data.user.id}`,document.cookie=`outfitpalsThirdParty=${t.data.user["third party"]}`,this.data=t.data.user,memberIndex.classList.add("opacity-0"),setTimeout(()=>{account.value="",pwd.value="",memberIndex.classList.add("d-none"),memberSignInProfile.classList.remove("d-none"),setTimeout(()=>{memberSignInProfile.classList.remove("opacity-0")},0)},400),this.renderMemberSignInProfileForm())}catch(t){console.log(t.response.data),memberIndexForm.classList.add("was-validated"),t.response.data.includes("user")?(account.classList.add("is-invalid"),account.nextElementSibling.textContent=t.response.data,account.setAttribute("style","border-color: var(--bs-form-invalid-border-color);background-image: url('../assets/images/member/invalid.png');background-repeat: no-repeat;background-position: right calc(0.375em + 0.1875rem) center;background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);")):(pwd.classList.add("is-invalid"),pwd.nextElementSibling.textContent=t.response.data,pwd.setAttribute("style","border-color: var(--bs-form-invalid-border-color);background-image: url('../assets/images/member/invalid.png');background-repeat: no-repeat;background-position: right calc(0.375em + 0.1875rem) center;background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);"))}},async renderMemberSignInProfileForm(){const e=Number(d("outfitpalsId")),t=d("outfitpalsToken");this.data=(await axios.get(`${k}users/${e}`,{headers:{authorization:`Bearer ${t}`}})).data;let i=`
        ...
        </div>`;memberSignInForm.innerHTML=e,document.getElementById("signInReservationTime").selectedIndex=this.data["reservation time selectedIndex"],document.getElementById("signInPopArea").selectedIndex=this.data["PopArea selectedIndex"],document.getElementById("signInStyle").selectedIndex=this.data["style selectedIndex"],document.getElementById("signInOutfitPrice").selectedIndex=this.data["outfit price selectedIndex"];const t=document.getElementById("signInImg"),i=document.querySelector(".signInPhoto");t.addEventListener("change",n=>{let r=new FileReader;r.addEventListener("load",m=>{i.setAttribute("src",m.target.result)}),r.readAsDataURL(n.target.files[0])})},async signOut(e){document.cookie="outfitpalsToken= ''",document.cookie="outfitpalsId= ''",document.cookie="outfitpalsThirdParty= ''",location.href="http://localhost:5173/outfitpals/pages/member.html"},async delete(e){try{const t=await axios.delete(`${k}users/${e}`);document.cookie="outfitpalsToken= ''",document.cookie="outfitpalsId= ''",document.cookie="outfitpalsThirdParty= ''"}catch(t){console.log(t)}}},l={regexp:new RegExp(""),checkAccount(e,t){return this.regexp=new RegExp("^[\\w\\d-]+\\@[\\d\\w]{3,}\\.[\\d\\w]{3,}(\\.[\\d\\w]{2,})?$"),t===""?(e.nextElementSibling.textContent="請輸入電子郵件",!1):this.regexp.test(t)?(e.classList.remove("is-invalid"),e.setAttribute("style","border-color: var(--bs-form-valid-border-color);background-image: url(../assets/images/member/valid.png);background-repeat: no-repeat;background-position: right calc(0.375em + 0.1875rem) center;background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);"),!0):(e.classList.add("is-invalid"),e.nextElementSibling.textContent="格式錯誤，電子郵件不包含特殊字元（如：!、#、$、%、^）",e.setAttribute("style","border-color: var(--bs-form-invalid-border-color);background-image: url('../assets/images/member/invalid.png');background-repeat: no-repeat;background-position: right calc(0.375em + 0.1875rem) center;background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);"),!1)},checkSignUpIndexPwd(e,t){return this.regexp=new RegExp("^[A-Z][\\d\\w]{7,}$"),t===""?(e.nextElementSibling.textContent="請輸入密碼",!1):this.regexp.test(t)?(e.classList.remove("is-invalid"),e.setAttribute("style","border-color: var(--bs-form-valid-border-color);background-image: url(../assets/images/member/valid.png);background-repeat: no-repeat;background-position: right calc(0.375em + 0.1875rem) center;background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);"),!0):(e.classList.add("is-invalid"),e.nextElementSibling.textContent="格式錯誤，密碼第一個為大寫英文，不包含特殊字元（如：!、@、#、$、%、^），最少 8 位英數字",e.setAttribute("style","border-color: var(--bs-form-invalid-border-color);background-image: url('../assets/images/member/invalid.png');background-repeat: no-repeat;background-position: right calc(0.375em + 0.1875rem) center;background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);"),!1)},checkMail(e,t){return this.regexp=new RegExp("^[\\w\\d-]+\\@[\\d\\w]{3,}\\.[\\d\\w]{3,}(\\.[\\d\\w]{2,})?$"),t===""?(e.nextElementSibling.textContent="請輸入電子郵件",!1):this.regexp.test(t)?(e.classList.remove("is-invalid"),e.setAttribute("style","border-color: var(--bs-form-valid-border-color);background-image: url(../assets/images/member/valid.png);background-repeat: no-repeat;background-position: right calc(0.375em + 0.1875rem) center;background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);"),!0):(e.classList.add("is-invalid"),e.nextElementSibling.textContent="格式錯誤，電子郵件不包含特殊字元（如：!、#、$、%、^）",e.setAttribute("style","border-color: var(--bs-form-invalid-border-color);background-image: url('../assets/images/member/invalid.png');background-repeat: no-repeat;background-position: right calc(0.375em + 0.1875rem) center;background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);"),!1)},checkName(e,t){return this.regexp=new RegExp("^[一-龥_a-zA-Z ]{5,}$"),t===""?(e.nextElementSibling.textContent="請輸入姓名",!1):this.regexp.test(t)?(e.classList.remove("is-invalid"),e.setAttribute("style","border-color: var(--bs-form-valid-border-color);background-image: url(../assets/images/member/valid.png);background-repeat: no-repeat;background-position: right calc(0.375em + 0.1875rem) center;background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);"),!0):(e.classList.add("is-invalid"),e.nextElementSibling.textContent="格式錯誤，姓名不包含數字或特殊字元（如：!、@、#、$、%、^）",e.setAttribute("style","border-color: var(--bs-form-invalid-border-color);background-image: url('../assets/images/member/invalid.png');background-repeat: no-repeat;background-position: right calc(0.375em + 0.1875rem) center;background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);"),!1)},checkPwd(e,t){return this.regexp=new RegExp("^[A-Z][\\d\\w]{7,}$"),t===""?(e.nextElementSibling.textContent="請輸入密碼",!1):this.regexp.test(t)?(e.classList.remove("is-invalid"),e.setAttribute("style","border-color: var(--bs-form-valid-border-color);background-image: url(../assets/images/member/valid.png);background-repeat: no-repeat;background-position: right calc(0.375em + 0.1875rem) center;background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);"),!0):(e.classList.add("is-invalid"),e.nextElementSibling.textContent="格式錯誤，密碼第一個為大寫英文，不包含特殊字元（如：!、@、#、$、%、^），最少 8 位英數字",e.setAttribute("style","border-color: var(--bs-form-invalid-border-color);background-image: url('../assets/images/member/invalid.png');background-repeat: no-repeat;background-position: right calc(0.375em + 0.1875rem) center;background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);"),!1)},checkNickName(e,t){return this.regexp=new RegExp("^[一-龥_a-zA-Z\\d ]{1,}$"),t===""?(e.nextElementSibling.textContent="請輸入暱稱",!1):this.regexp.test(t)?(e.classList.remove("is-invalid"),e.setAttribute("style","border-color: var(--bs-form-valid-border-color);background-image: url(../assets/images/member/valid.png);background-repeat: no-repeat;background-position: right calc(0.375em + 0.1875rem) center;background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);"),!0):(e.classList.add("is-invalid"),e.nextElementSibling.textContent="格式錯誤，暱稱最少三個英數字，不包含特殊字元（如：!、@、#、$、%、^）",e.setAttribute("style","border-color: var(--bs-form-invalid-border-color);background-image: url('../assets/images/member/invalid.png');background-repeat: no-repeat;background-position: right calc(0.375em + 0.1875rem) center;background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);"),!1)},checkBirth(e,t){return this.regexp=new RegExp("^[\\d]{4}-[\\d]{2}-[\\d]{2}$"),t===""?(e.nextElementSibling.textContent="請輸入生日",!1):this.regexp.test(t)?(e.classList.remove("is-invalid"),e.setAttribute("style","border-color: var(--bs-form-valid-border-color);background-image: url(../assets/images/member/valid.png);background-repeat: no-repeat;background-position: right calc(0.375em + 0.1875rem) center;background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);"),!0):(e.classList.add("is-invalid"),e.nextElementSibling.textContent="格式錯誤，請輸入西元年/月/日",e.setAttribute("style","border-color: var(--bs-form-invalid-border-color);background-image: url('../assets/images/member/invalid.png');background-repeat: no-repeat;background-position: right calc(0.375em + 0.1875rem) center;background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);"),!1)},checkTel(e,t){return this.regexp=new RegExp("^09[\\d]{8}$"),t===""?(e.nextElementSibling.textContent="請輸入手機號碼",!1):this.regexp.test(t)?(e.classList.remove("is-invalid"),e.setAttribute("style","border-color: var(--bs-form-valid-border-color);background-image: url(../assets/images/member/valid.png);background-repeat: no-repeat;background-position: right calc(0.375em + 0.1875rem) center;background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);"),!0):(e.classList.add("is-invalid"),e.nextElementSibling.textContent="格式錯誤，格式為0912345678",e.setAttribute("style","border-color: var(--bs-form-invalid-border-color);background-image: url('../assets/images/member/invalid.png');background-repeat: no-repeat;background-position: right calc(0.375em + 0.1875rem) center;background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);"),!1)},checkReservationLocation(e,t){return this.regexp=new RegExp("^[一-龥_a-zA-Z ]{2,}$"),t===""?(e.nextElementSibling.textContent="請輸入開放預約地點",!1):this.regexp.test(t)?(e.classList.remove("is-invalid"),e.setAttribute("style","border-color: var(--bs-form-valid-border-color);background-image: url(../assets/images/member/valid.png);background-repeat: no-repeat;background-position: right calc(0.375em + 0.1875rem) center;background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);"),!0):(e.classList.add("is-invalid"),e.nextElementSibling.textContent="格式錯誤，不包含數字或特殊字元（如：!、@、#、$、%、^）",e.setAttribute("style","border-color: var(--bs-form-invalid-border-color);background-image: url('../assets/images/member/invalid.png');background-repeat: no-repeat;background-position: right calc(0.375em + 0.1875rem) center;background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);"),!1)}};async function R(e,t,i,n,r,m,g,$,B,v,u,p,b,f,y,I,h,x,w){w.classList.add("was-validated");let a={};if(t.addEventListener("keyup",s=>{l.checkName(s.target,s.target.value)}),t.addEventListener("paste",s=>{l.checkName(s.target,s.target.value)}),i.addEventListener("keyup",s=>{l.checkPwd(s.target,s.target.value)}),i.addEventListener("paste",s=>{l.checkPwd(s.target,s.target.value)}),n.addEventListener("keyup",s=>{l.checkNickName(s.target,s.target.value)}),n.addEventListener("paste",s=>{l.checkNickName(s.target,s.target.value)}),r.addEventListener("keyup",s=>{l.checkBirth(s.target,s.target.value)}),r.addEventListener("paste",s=>{l.checkBirth(s.target,s.target.value)}),m.addEventListener("keyup",s=>{l.checkMail(s.target,s.target.value)}),m.addEventListener("paste",s=>{l.checkMail(s.target,s.target.value)}),g.addEventListener("keyup",s=>{l.checkTel(s.target,s.target.value)}),g.addEventListener("paste",s=>{l.checkTel(s.target,s.target.value)}),u.addEventListener("keyup",s=>{l.checkReservationLocation(s.target,s.target.value)}),u.addEventListener("paste",s=>{l.checkReservationLocation(s.target,s.target.value)}),l.checkName(t,t.value)&&l.checkPwd(i,i.value)&&l.checkNickName(n,n.value)&&l.checkBirth(r,r.value)&&l.checkTel(g,g.value)&&l.checkReservationLocation(u,u.value)&&w.checkValidity()){a.image=e.getAttribute("src"),a.name=t.value,a.password=i.value,a["nick name"]=n.value,a.birthday=r.value,a.tel=g.value,a.email=m.value,a["reservation time"]=v.value,a["reservation time selectedIndex"]=v.selectedIndex,a["reservation location"]=u.value,a.height=p.value?p.value:"",a.weight=b.value?b.value:"",a.PopArea=f.value,a["PopArea selectedIndex"]=f.selectedIndex,a.style=y.value,a["style selectedIndex"]=y.selectedIndex,a["outfit price"]=I.value,a["outfit price selectedIndex"]=I.selectedIndex,a["love store"]=h.value?h.value:"",a.introduce=x.value?x.value:"",$.checked===!0?a.sex="Male":a.sex="Female";const s=Number(d("outfitpalsId")),q=d("outfitpalsToken");await E.patchUsers(s,q,a),location.href="https://bftsai.github.io/outfitpals/member.html",signUpPhoto.setAttribute("src","../assets/images/member/user-solid.svg"),t.value="",i.value="",n.value="",r.value="",g.value="",m.value="",v.selectedIndex=0,u.value="",p.value="",b.value="",f.selectedIndex=0,y.selectedIndex=0,I.selectedIndex=0,h.value="",x.value=""}else console.log("all false")}const A=document.querySelector(".member-index"),P=document.querySelector(".memberIndexForm");document.querySelector(".member-signUpData");const M=document.querySelector(".memberSignUpForm"),T=document.querySelector(".member-signInProfile");document.querySelector(".memberSignInProfileForm");document.querySelector(".member-signInData");const j=document.querySelector(".memberSignInForm"),N=document.querySelector(".signInBtn"),z=document.querySelector(".signUpBtn"),L=document.querySelector(".gmailSignIn"),S=document.querySelector(".gmailSignUp"),o=document.getElementById("account"),c=document.getElementById("pwd"),F=document.getElementById("signUpImg");let C=document.querySelector(".signUpPhoto");const D=document.getElementById("signUpPwd"),O=document.getElementById("signUpMail"),H=document.getElementById("signUpName"),W=document.getElementById("signUpNickName"),Z=document.getElementById("signUpBirth"),V=document.getElementById("signUpTel"),_=document.getElementById("signUpMale"),G=document.getElementById("signUpFemale"),J=document.getElementById("signUpReservationTime"),K=document.getElementById("signUpReservationLocation"),Q=document.getElementById("signUpHeight"),X=document.getElementById("signUpWeight"),Y=document.getElementById("signUpPopArea"),ee=document.getElementById("signUpStyle"),te=document.getElementById("signUpOutfitPrice"),se=document.getElementById("signUpLoveStore"),le=document.getElementById("signUpIntroduce"),U=document.querySelector(".memberIndexSubmit"),ae=document.querySelector(".memberIndexCancel"),ie=document.querySelector(".memberSignUpSubmit");d("outfitpalsThirdParty")==="false"&&d("outfitpalsToken")&&d("outfitpalsId")&&(A.classList.add("opacity-0"),o.value="",c.value="",E.renderMemberSignInProfileForm(),A.classList.add("d-none"),T.classList.remove("d-none"),T.classList.remove("opacity-0"));N.addEventListener("click",e=>{[...e.target.offsetParent.children].forEach(t=>{t.classList.remove("active")}),o.value="",c.value="",U.textContent="登入",P.classList.remove("was-validated"),o.classList.remove("is-invalid"),o.setAttribute("style",""),c.classList.remove("is-invalid"),c.setAttribute("style",""),e.target.classList.add("active"),S.classList.add("opacity-0"),setTimeout(()=>{S.classList.add("d-none"),L.classList.remove("d-none"),setTimeout(()=>{L.classList.remove("opacity-0")},0)},400)});z.addEventListener("click",e=>{[...e.target.offsetParent.children].forEach(t=>{t.classList.remove("active")}),o.value="",c.value="",U.textContent="註冊",P.classList.remove("was-validated"),o.classList.remove("is-invalid"),o.setAttribute("style",""),c.classList.remove("is-invalid"),c.setAttribute("style",""),e.target.classList.add("active"),L.classList.add("opacity-0"),setTimeout(()=>{L.classList.add("d-none"),S.classList.remove("d-none"),setTimeout(()=>{S.classList.remove("opacity-0")},0)},400)});U.addEventListener("click",e=>{if(e.preventDefault(),e.stopPropagation(),P.classList.add("was-validated"),l.checkAccount(o,o.value),l.checkSignUpIndexPwd(c,c.value),o.addEventListener("keyup",t=>{l.checkAccount(t.target,t.target.value)}),o.addEventListener("paste",t=>{l.checkAccount(t.target,t.target.value)}),c.addEventListener("keyup",t=>{l.checkSignUpIndexPwd(t.target,t.target.value)}),c.addEventListener("paste",t=>{l.checkSignUpIndexPwd(t.target,t.target.value)}),l.checkAccount(o,o.value)&&l.checkSignUpIndexPwd(c,c.value)){let t={};t.email=o.value,t.password=c.value,t["third party"]="false",N.className.includes("active")?E.signIn(t):E.register(t)}});ae.addEventListener("click",e=>{o.value="",c.value=""});F.addEventListener("change",e=>{let t=new FileReader;t.addEventListener("load",i=>{C.setAttribute("src",i.target.result)}),t.readAsDataURL(e.target.files[0])});ie.addEventListener("click",e=>{e.preventDefault(),e.stopPropagation(),R(C,H,D,W,Z,O,V,_,G,J,K,Q,X,Y,ee,te,se,le,M)});j.addEventListener("click",e=>{document.getElementById("signInImg");const t=document.querySelector(".signInPhoto"),i=document.getElementById("signInPwd"),n=document.getElementById("signInMail"),r=document.getElementById("signInName"),m=document.getElementById("signInNickName"),g=document.getElementById("signInBirth"),$=document.getElementById("signInTel"),B=document.getElementById("signInMale"),v=document.getElementById("signInFemale"),u=document.getElementById("signInReservationTime"),p=document.getElementById("signInReservationLocation"),b=document.getElementById("signInHeight"),f=document.getElementById("signInWeight"),y=document.getElementById("signInPopArea"),I=document.getElementById("signInStyle"),h=document.getElementById("signInOutfitPrice"),x=document.getElementById("signInLoveStore"),w=document.getElementById("signInIntroduce");e.target.className.includes("memberSignInReviseSubmit")?(e.preventDefault(),e.stopPropagation(),R(t,r,i,m,g,n,$,B,v,u,p,b,f,y,I,h,x,w,j)):e.target.className.includes("memberSignInReviseCancel")&&(location.href="http://localhost:5173/outfitpals/pages/member.html")},!1);
