                ...
                <div class="container ">
                 ...
                 <br>`,U.innerHTML+=`<div class="container mb-5 ">
                    ...
                    <div class="row justify-content-center mt-4  coll" id="cardRow"></div>
                                            ...
                                            </div>`;document.querySelectorAll(".card1").forEach(function(y,M){let k=y.getAttribute("id").trim();y.addEventListener("click",function(s){s.stopPropagation(),s.preventDefault(),window.location.href=`${ee}/pages/information.html?postId=`+k})})})})});axios.get(`${q}600/posts?userId=${N}`,{headers:{authorization:`Bearer ${O}`}}).then(function(f){let c=f.data;const v=location.href.split("=")[1];re.innerHTML=`<div class="row justify-content-center post1">
                            </div>
