...
//init
if(localStorage.outfitpalsThirdParty==='false'){
...
memberSignUpSubmit.addEventListener('click',e=>{
    e.preventDefault();
    e.stopPropagation();
    console.log(signUpPhoto.value,signUpName.value,signUpPwd.value,signUpNickName.value,signUpBirth.value,signUpMail.value,signUpTel.value,signUpMale.value,signUpFemale.value,signUpReservationTime.value,signUpReservationLocation.value,signUpHeight.value,signUpWeight.value,signUpPopArea.value,signUpStyle.value,signUpOutfitPrice.value,signUpLoveStore.value,signUpIntroduce.value);
