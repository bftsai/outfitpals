import{c as l,a,l as r}from"./main-4f4ff050.js";function o(s){const e=document.cookie.split(";").find(t=>{if(t.split("=")[0].trim()===s)return t});return e===void 0?void 0:e.split("=")[1]}const i=document.querySelector(".memberSpinner"),m={data:[],async getUserData(s){try{const e=await l.get(`${a}440/users/${s}`,{headers:{authorization:`Bearer ${o("outfitpalsToken")}`}});return this.data=e.data,this.data}catch(e){this.signOut(),console.log(e.response)}},async register(s){try{i.classList.remove("d-none");const e=await l.post(`${a}register`,s);if(e.status===201){console.log(e),document.cookie=`outfitpalsToken=${e.data.accessToken}`,document.cookie=`outfitpalsId=${e.data.user.id}`,document.cookie=`outfitpalsThirdParty=${e.data.user["third party"]}`;const t=Number(o("outfitpalsId")),n=o("outfitpalsToken");await this.patchUsers(t,n,{"sign time":new Date().toUTCString()}),await this.postPersonal(),signUpMail.value=account.value,signUpPwd.value=pwd.value,i.classList.add("d-none"),memberIndex.classList.add("opacity-0"),setTimeout(()=>{account.value="",pwd.value="",memberIndex.classList.add("d-none"),memberSignUpData.classList.remove("d-none"),setTimeout(()=>{memberSignUpData.classList.remove("opacity-0")},0)},400)}}catch(e){console.log(e),memberIndexForm.classList.add("was-validated"),account.classList.add("is-invalid"),account.classList.add("is-invalid-customer"),account.nextElementSibling.textContent=e.response.data,i.classList.add("d-none"),this.signOut()}},async postPersonal(){try{const s=await l.post(`${a}personal`,{isopen:!1,userId:Number(o("outfitpalsId")),otherdate:[],pos1:"請填寫",pos2:"請填寫",pos3:"請填寫",pos4:"請填寫",okday:[],oktime:"12:00~12:00"})}catch(s){console.log(s.response)}},async deleteUser(s){try{i.classList.remove("d-none");const e=await l.delete(`${a}600/users/${s}`,{headers:{authorization:`Bearer ${o("outfitpalsToken")}`}});i.classList.add("d-none"),location.href=`${r}member.html`,document.cookie="outfitpalsToken= ''",document.cookie="outfitpalsId= ''",document.cookie="outfitpalsThirdParty= ''"}catch(e){console.log(e.response)}},async patchUsers(s,e,t){try{i.classList.remove("d-none");const n=await l.patch(`${a}600/users/${s}`,t,{headers:{authorization:`Bearer ${e}`}});i.classList.add("d-none")}catch(n){i.classList.add("d-none"),this.signOut(),console.log(n.response)}},async signIn(s){try{i.classList.remove("d-none");const e=await l.post(`${a}signin`,s);e.status===200&&(document.cookie=`outfitpalsToken=${e.data.accessToken}`,document.cookie=`outfitpalsId=${e.data.user.id}`,document.cookie=`outfitpalsThirdParty=${e.data.user["third party"]}`,this.data=e.data.user,i.classList.add("d-none"),memberIndex.classList.add("opacity-0"),setTimeout(()=>{account.value="",pwd.value="",memberIndex.classList.add("d-none"),memberSignInProfile.classList.remove("d-none"),setTimeout(()=>{memberSignInProfile.classList.remove("opacity-0")},0)},400),location.href=`${r}member.html`)}catch(e){console.log(e.response.data),i.classList.add("d-none"),memberIndexForm.classList.add("was-validated"),e.response.data.includes("user")?(account.classList.add("is-invalid"),account.nextElementSibling.textContent=e.response.data,account.setAttribute("style","border-color: var(--bs-form-invalid-border-color);background-image: url('../assets/images/member/invalid.png');background-repeat: no-repeat;background-position: right calc(0.375em + 0.1875rem) center;background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);")):(pwd.classList.add("is-invalid"),pwd.nextElementSibling.textContent=e.response.data,pwd.setAttribute("style","border-color: var(--bs-form-invalid-border-color);background-image: url('../assets/images/member/invalid.png');background-repeat: no-repeat;background-position: right calc(0.375em + 0.1875rem) center;background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);"))}},async signOut(){i.classList.remove("d-none"),document.cookie="outfitpalsToken= ''",document.cookie="outfitpalsId= ''",document.cookie="outfitpalsThirdParty= ''",i.classList.add("d-none"),location.href=`${r}member.html`},async renderMemberSignInProfileForm(){try{const s=Number(o("outfitpalsId")),e=o("outfitpalsToken");i.classList.remove("d-none"),this.data=(await l.get(`${a}600/users/${s}`,{headers:{authorization:`Bearer ${e}`}})).data,i.classList.add("d-none");let t=`
        ...
        </div>`;if(memberSignInForm.innerHTML=s,o("outfitpalsThirdParty")==="google"){const n=document.getElementById("signInPwd"),c=document.getElementById("signInMail");n.value=this.data["g-pwd"],n.setAttribute("disabled",""),c.setAttribute("disabled","")}document.getElementById("signInPopArea").selectedIndex=this.data["PopArea selectedIndex"],document.getElementById("signInStyle").selectedIndex=this.data["style selectedIndex"],document.getElementById("signInOutfitPrice").selectedIndex=this.data["outfit price selectedIndex"];const e=document.getElementById("signInImg"),t=document.querySelector(".signInPhoto");e.addEventListener("change",n=>{let c=new FileReader;c.addEventListener("load",d=>{t.setAttribute("src",d.target.result)}),c.readAsDataURL(n.target.files[0])})},async postPosts(s){try{await this.getUserData(o("outfitpalsId")),s.author=this.data.name,s.postTime=new Date().toUTCString();const e=await l.post(`${a}600/posts`,s,{headers:{authorization:`Bearer ${o("outfitpalsToken")}`}});console.log(e)}catch(e){console.log(e.response),this.signOut()}},async getPosts(){try{return(await l.get(`${a}600/posts?userId=${o("outfitpalsId")}`,{headers:{authorization:`Bearer ${o("outfitpalsToken")}`}})).data}catch(s){console.log(s.response),this.signOut()}},async getPostsById(s){try{return(await l.get(`${a}440/posts?PostId=${s}`,{headers:{authorization:`Bearer ${o("outfitpalsToken")}`}})).data}catch(e){console.log(e.response),this.signOut()}},async deletePosts(s){try{const e=await l.delete(`${a}600/posts/${s}`,{headers:{authorization:`Bearer ${o("outfitpalsToken")}`}});console.log(e)}catch(e){console.log(e.response)}},async postComment(s){try{s.postTime=new Date().toUTCString();const e=await l.post(`${a}600/comments`,s,{headers:{authorization:`Bearer ${o("outfitpalsToken")}`}});console.log(e)}catch(e){console.log(e.response),this.signOut()}},async getComment(s){try{return(await l.get(`${a}440/comments/${s}`,{headers:{authorization:`Bearer ${o("outfitpalsToken")}`}})).data}catch(e){console.log(e.response),this.signOut()}},async deleteComment(s){try{const e=await l.delete(`${a}600/comments/${s}`,{headers:{authorization:`Bearer ${o("outfitpalsToken")}`}});console.log(e)}catch(e){console.log(e.response)}},async patchComment(s,e){try{const t=await l.patch(`${a}660/comments/${s}`,e,{headers:{authorization:`Bearer ${o("outfitpalsToken")}`}});return console.log(t),t}catch(t){console.log(t.response),this.signOut()}},async getAllUserComment(s){try{return(await l.get(`${a}440/comments?userId=${s}`,{headers:{authorization:`Bearer ${o("outfitpalsToken")}`}})).data}catch(e){console.log(e.response),this.signOut()}},async getAllPostComment(s){try{return(await l.get(`${a}440/comments?posterId=${s}`,{headers:{authorization:`Bearer ${o("outfitpalsToken")}`}})).data}catch(e){console.log(e.response),this.signOut()}},async getPostComment(s,e){try{const t=(await l.get(`${a}440/comments?posterId=${s}&_page=${e}&_limit=2&_sort=${s}&_order=asc`,{headers:{authorization:`Bearer ${o("outfitpalsToken")}`}})).data;return console.log(t),t}catch(t){console.log(t.response),this.signOut()}},async getUserComment(s,e){try{const t=(await l.get(`${a}440/comments?userId=${s}&_page=${e}&_limit=2&_sort=${s}&_order=asc`,{headers:{authorization:`Bearer ${o("outfitpalsToken")}`}})).data;return console.log(t),t}catch(t){console.log(t.response),this.signOut()}},async postProfile(s){try{const e=await l.post(`${a}profile`,s)}catch(e){console.log(e.response),this.signOut()}},async getProfile(){try{const s=(await l.get(`${a}profile`)).data}catch(s){console.log(s.response),this.signOut()}},async deleteProfile(s){try{const e=await l.delete(`${a}600/profile/${s}`,{headers:{authorization:`Bearer ${o("outfitpalsToken")}`}})}catch(e){console.log(e.response)}},async patchPersonalOtherday(s,e){try{const t=(await l.get(`${a}personal?userId=${s}`)).data[0];t.otherdate.push(e);const n=(await l.patch(`${a}personal/${s}`,t)).data;console.log(n)}catch(t){console.log(t.response),this.signOut()}}};export{m as a,o as c};
