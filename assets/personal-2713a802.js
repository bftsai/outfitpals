import{a as I,b as Z}from"./main-4f4ff050.js";const E=document.querySelectorAll(".thumb-link");document.querySelectorAll(".thumb");const P=document.querySelector("#personalmain"),D=document.querySelector("#reserve"),K=document.querySelector("#personalnav"),X=document.querySelector("#personalselect"),C=document.querySelector("#collect"),T=document.querySelector("#noopen"),M=document.querySelector("#nopost"),se=document.querySelector(".setting"),oe=document.querySelector("#left"),ae=document.querySelector("#right"),N=document.querySelector("#months"),O=document.querySelectorAll("td"),ie=document.querySelector("#open"),ce=document.querySelector(".close"),R=document.querySelector(".p1"),V=document.querySelector(".p2"),J=document.querySelector(".p3"),z=document.querySelector(".p4"),Y=document.querySelector(".t1"),F=document.querySelector(".m1"),_=document.querySelector(".t2"),G=document.querySelector(".m2"),le=document.querySelector(".personal"),re=document.querySelector(".otherspost");document.querySelector(".collectpost");let l=document.getElementsByTagName("td");var B=new Date,A=B.getMonth()+1,L=B.getMonth(),n=L+1,p=B.getFullYear(),de=new Date(p,L,1),ee=de.getDay(),j=[31,28,31,30,31,30,31,31,30,31,30,31];(p%4==0&&p%100!=0||p%400==0)&&(j[1]=29);let Q=B.getDate();l[ee+Q-2].setAttribute("id","current-day");function te(h){const a=document.cookie.split(";").map(v=>v.trim());for(const v of a){const[b,S]=v.split("=");if(b===h)return decodeURIComponent(S)}return null}const W=te("outfitpalsToken"),U=te("outfitpalsId");axios.get(`${I}640/users?id=${U}`,{headers:{authorization:`Bearer ${W}`}}).then(function(h){le.innerHTML=`
                ...
                <button type="button" class="btn btn-primary btn-pill mt-3 ms-3">${v[1]}</button>`,document.querySelector("#reservebtn").addEventListener("click",function(){K.classList.add("d-none"),X.classList.add("d-none"),D.classList.add("d-none"),P.classList.add("d-none"),M.classList.add("d-none"),C.classList.remove("d-none"),C.innerHTML=`
                <div class="container ">
                 ...
                 <br>`,C.innerHTML+=`<div class="container mb-5 ">
                    ...
                    <div class="row justify-content-center mt-4  coll" id="cardRow"></div>
                            ...
                            `;const b=9,S=[".post1",".post2",".post3"],H=(v-1)*b,w=H+b;for(let s=H;s<w&&s<a.length;s++){const d=s%b;S.forEach((m,g)=>{if(d>=g*(b/S.length)&&d<(g+1)*(b/S.length)){const e=document.querySelector(m),r=a[s].imgUrl,o=a[s].id;e.innerHTML+=`<div class="col-4">
                                                                    ...
                                                                    </div>`}})}document.querySelectorAll(".card1").forEach(function(s,d){let m=s.getAttribute("id").trim();s.addEventListener("click",function(g){g.stopPropagation(),g.preventDefault(),window.location.href=`${Z}/information.html?postId=`+m})});const k=document.querySelector(".page");let y=100;if(a.length>0)for(let s=1;s<=Math.min(y,Math.ceil(a.length/8));s++)k.innerHTML+=`<li class="page-item"><a href="#" class="page-link border-0">${s}</a></li>`;const x=document.querySelector(".l");document.querySelector(".r").addEventListener("click",function(s){const d=new URLSearchParams(window.location.search);var m=parseInt(d.get("page"))||1,g=m+1;d.set("page",g);var e=window.location.origin+window.location.pathname+"?"+d.toString();window.history.replaceState({},document.title,e)}),x.addEventListener("click",function(s){const d=new URLSearchParams(window.location.search);var m=parseInt(d.get("page"))||1;if(m>1){var g=m-1;d.set("page",g);var e=window.location.origin+window.location.pathname+"?"+d.toString();window.history.replaceState({},document.title,e)}})}else M.classList.remove("d-none"),K.classList.add("d-none"),C.classList.add("d-none"),T.classList.add("d-none"),M.classList.add("d-none")});W!=null&&function(){try{axios.get(`${I}personal?userId=${U}`).then(function(a){const v=a.data[0].isopen,[b,S,H,w]=a.data[0].oktime.split(/[~:]/),$=a.data[0].otherdate,k=a.data[0].okday,y=a.data[0].id;if(v===!0){R.placeholder=JSON.stringify(a.data[0].pos1).replace(/"/g,""),V.placeholder=JSON.stringify(a.data[0].pos2).replace(/"/g,""),J.placeholder=JSON.stringify(a.data[0].pos3).replace(/"/g,""),z.placeholder=JSON.stringify(a.data[0].pos4).replace(/"/g,""),Y.placeholder=b,F.placeholder=S,_.placeholder=H,G.placeholder=w;for(var x=1;x<=j[L];x++){var q=ee+x-2;q>=0&&q<l.length&&(l[q].innerHTML=x,$.forEach(function(e){let r=e.split("/")[1],o=e.split("/")[0];parseInt(r)===x&&n===parseInt(o)&&(l[q].innerHTML='<i class="bi bi-calendar-x-fill d-flex justify-content-center text-danger"></i>')}),k.forEach(function(e){let r=e.split("/")[1],o=e.split("/")[0];parseInt(r)===x&&n===parseInt(o)&&(l[q].innerHTML='<i class="bi bi-calendar2-check-fill d-flex justify-content-center text-info">')}))}let s=[];O.forEach(function(e,r){e.querySelector("i.bi.bi-calendar-x-fill.text-danger")?s.push({day:r,hasIcon:!0}):s.push({day:r,hasIcon:!1})}),N.innerHTML=`<strong class="fs-2"  id="months">${p}-${n}月</strong>`,oe.addEventListener("click",function(){O.forEach(function(t,u){t.innerHTML="　"});var e=document.getElementById("current-day");e&&e.removeAttribute("id"),n>1?(n-=1,L-=1):n===1&&(n=12,L=11,p-=1);var r=new Date(p,L,1),o=r.getDay();o===0&&(o=7),(p%4==0&&p%100!=0||p%400==0)&&(j[1]=29);for(var i=1;i<=j[L];i++){var c=o+i-2;c>=0&&c<l.length&&(n==A?(l[c].innerHTML=i,$.forEach(function(t){let u=t.split("/")[1],f=t.split("/")[0];parseInt(u)===i&&n===parseInt(f)&&(l[c].innerHTML='<i class="bi bi-calendar-x-fill d-flex justify-content-center text-danger"></i>')}),k.forEach(function(t){let u=t.split("/")[1],f=t.split("/")[0];parseInt(u)===i&&n===parseInt(f)&&(l[c].innerHTML='<i class="bi bi-calendar2-check-fill d-flex justify-content-center text-info">')})):(l[c].innerHTML=i,g[c]=i,$.forEach(function(t){let u=t.split("/")[1],f=t.split("/")[0];parseInt(u)===i&&n===parseInt(f)&&(l[c].innerHTML='<i class="bi bi-calendar-x-fill d-flex justify-content-center text-danger"></i>')}),k.forEach(function(t){let u=t.split("/")[1],f=t.split("/")[0];parseInt(u)===i&&n===parseInt(f)&&(l[c].innerHTML='<i class="bi bi-calendar2-check-fill d-flex justify-content-center text-info">')})))}N.innerHTML=`<strong class="fs-2"  id="months">${p}-${n}月</strong>`,n==A&&l[o+Q-2].setAttribute("id","current-day")}),ae.addEventListener("click",function(){O.forEach(function(t,u){t.innerHTML="　"});var e=document.getElementById("current-day");e&&e.removeAttribute("id"),n<12?(n+=1,L+=1):n===12&&(n=1,L=0,p+=1);var r=new Date(p,L,1),o=r.getDay();o===0&&(o=7),(p%4==0&&p%100!=0||p%400==0)&&(j[1]=29);for(var i=1;i<=j[L];i++){var c=o+i-2;c>=0&&c<l.length&&(n==A?(l[c].innerHTML=i,$.forEach(function(t){let u=t.split("/")[1],f=t.split("/")[0];parseInt(u)===i&&n===parseInt(f)&&(l[c].innerHTML='<i class="bi bi-calendar-x-fill d-flex justify-content-center text-danger"></i>')}),k.forEach(function(t){let u=t.split("/")[1],f=t.split("/")[0];parseInt(u)===i&&n===parseInt(f)&&(l[c].innerHTML='<i class="bi bi-calendar2-check-fill d-flex justify-content-center text-info">')})):(l[c].innerHTML=i,g[c]=i,$.forEach(function(t){let u=t.split("/")[1],f=t.split("/")[0];parseInt(u)===i&&n===parseInt(f)&&(l[c].innerHTML='<i class="bi bi-calendar-x-fill d-flex justify-content-center text-danger"></i>')}),k.forEach(function(t){let u=t.split("/")[1],f=t.split("/")[0];parseInt(u)===i&&n===parseInt(f)&&(l[c].innerHTML='<i class="bi bi-calendar2-check-fill d-flex justify-content-center text-info">')})))}N.innerHTML=`<strong class="fs-2"  id="months">${p}-${n}月</strong>`,n==A&&l[o+Q-2].setAttribute("id","current-day")});let d=[];const m=[],g=[];O.forEach(function(e,r){m[r]=e.innerHTML,e.addEventListener("click",function(o){A==n?e.classList.contains("go")?(e.classList.remove("go"),e.innerHTML=m[r],d.pop()):(d.push(`${n}/${o.target.textContent}`),e.classList.add("go"),e.innerHTML='<i class="bi bi-calendar2-check-fill text-info d-flex justify-content-center "></i>'):e.classList.contains("go")?(e.classList.remove("go"),e.innerHTML=g[r],d.pop()):(d.push(`${n}/${o.target.textContent}`),e.classList.add("go"),e.innerHTML='<i class="bi bi-calendar2-check-fill text-info d-flex justify-content-center "></i>')})});for(let e=0;e<E.length;e++)E[e].addEventListener("click",function(r){r.preventDefault();for(let o=0;o<E.length;o++)E[o].querySelector(".thumb").classList.remove("active");this.querySelector(".thumb").classList.add("active"),this.querySelector(".thumb").textContent==="貼文總覽"?(P.classList.remove("d-none"),D.classList.add("d-none"),T.classList.add("d-none"),M.classList.add("d-none")):(T.classList.add("d-none"),D.classList.remove("d-none"),P.classList.add("d-none"),M.classList.add("d-none"))});se.addEventListener("click",function(){let e=Y.value||Y.placeholder,r=F.value||F.placeholder,o=_.value||_.placeholder,i=G.value||G.placeholder,c=R.value||R.placeholder,t=V.value||V.placeholder,u=J.value||J.placeholder,f=z.value||z.placeholder,ne=`${e}:${r}~${o}:${i}`;axios.patch(`${I}personal/${y}`,{pos1:c,pos2:t,pos3:u,pos4:f,okday:d,oktime:ne})}),ce.addEventListener("click",function(){axios.patch(`${I}personal/${y}`,{isopen:!1}).then(function(e){T.classList.remove("d-none"),D.classList.add("d-none"),M.classList.add("d-none"),location.reload()})})}else if(v!==!0){for(let s=0;s<E.length;s++)E[s].addEventListener("click",function(d){d.preventDefault();for(let m=0;m<E.length;m++)E[m].querySelector(".thumb").classList.remove("active");this.querySelector(".thumb").classList.add("active"),this.querySelector(".thumb").textContent==="貼文總覽"?(P.classList.remove("d-none"),T.classList.add("d-none"),M.classList.add("d-none")):(T.classList.remove("d-none"),P.classList.add("d-none"),M.classList.add("d-none"))});ie.addEventListener("click",function(){axios.patch(`${I}personal/${y}`,{isopen:!0}).then(function(){T.classList.add("d-none"),D.classList.remove("d-none"),M.classList.add("d-none"),location.reload()}).then(function(){T.classList.add("d-none"),D.classList.remove("d-none"),location.reload()})})}})}catch(a){console.error("Error fetching data:",a)}}();
